...
export const vitalEintraege = mysqlTable("vital_eintraege", {
  ...
  /** Essverhalten: Anzahl Mahlzeiten heute – 0=Fasten, 1=OMAD, 2-4=Mahlzeiten */
...
export const trainingEinheiten = mysqlTable('training_einheiten', {
  ...
  externerLink: text('externerLink'),
  /** Beschriftung des externen Links, z.B. "Mehr erfahren" */
  externerLinkLabel: varchar('externerLinkLabel', { length: 200 }),
