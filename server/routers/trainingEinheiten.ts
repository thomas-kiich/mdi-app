...
const einheitInput = z.object({
  ...
  externerLink: z.string().url().optional().or(z.literal("")),
  externerLinkLabel: z.string().max(200).optional().or(z.literal("")),
  ...
  create: protectedProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      ...
      const result = await db.insert(trainingEinheiten).values({
        ...
        externerLink: input.externerLink || null,
        externerLinkLabel: input.externerLinkLabel || null,
