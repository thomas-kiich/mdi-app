                ...
                <div className="container max-w-4xl mx-auto px-4 py-16 md:py-24 relative z-10">
                  <div className="flex flex-col items-center text-center space-y-6">
                    ...
                    <div className="flex flex-wrap justify-center gap-3 mt-1">
                      <button
                        onClick={() => { import('sonner').then(m => m.toast('WhatsApp Community startet bald – bleib dran! 🟢')) }}
                        className="flex items-center gap-2 px-5 py-2 text-xs font-semibold tracking-widest uppercase border border-green-600/50 text-green-400 hover:border-green-400 hover:text-green-300 transition-all duration-200"
                      >
                      ...
                      <button
                        onClick={() => { import('sonner').then(m => m.toast('Telegram Community startet bald – bleib dran! 🔵')) }}
                        className="flex items-center gap-2 px-5 py-2 text-xs font-semibold tracking-widest uppercase border border-sky-600/50 text-sky-400 hover:border-sky-400 hover:text-sky-300 transition-all duration-200"
                      >
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
