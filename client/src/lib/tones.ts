...
export const COLOR_SEGMENTS: ColorSegment[] = [
  ...
  { id: "7_25", x: 7, y: 25, color: "#c2e9e7", rgb: [194, 233, 231] },
  ...
  { id: "7_50", x: 7, y: 50, color: "#82d3d0", rgb: [130, 211, 208] },
  ...
  { id: "7_75", x: 7, y: 75, color: "#3fc4bc", rgb: [63, 196, 188] },
  ...
  { id: "7_100", x: 7, y: 100, color: "#00B5AD", rgb: [0, 181, 173] },
