...
export function Method36Trainer({ frequency, toneName, color, typeId, duration, onClose }: Method36TrainerProps) {
    ...
    const INTRO_AUDIO_URL = '/api/audio-proxy?url=' + encodeURIComponent('https://d2xsxph8kpxj0f.cloudfront.net/310519663036873684/VyRb5akas5jLZtUDKwE632/methode36-intro-final_1e4d0d33.mp3');
            ...
            <div className="absolute top-6 left-6 right-6 flex justify-between items-center z-10">
                <div className="flex items-center gap-3">
                    ...
                    >
                        ...
                        <span className="font-bold tracking-widest uppercase">GEBRAUCHSANLEITUNG ANHÖREN</span>
                    </button>
                    {showIntroAudio && (
